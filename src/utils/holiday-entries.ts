...
// 构建时拉取 timor.tech 中国法定节假日，合并 builtinHolidays，按 dateKey 排序返回
// 失败时仅返回 builtinHolidays 兜底
// 供 /api/holidays.json endpoint 与日历页面 SSR 共用，避免页面自 fetch
export async function getHolidayEntries(): Promise<HolidayEntry[]> {
